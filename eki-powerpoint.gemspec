...
Gem::Specification.new do |spec|
  spec.name          = "eki-powerpoint"
  spec.version       = EkiPowerpoint::VERSION
  ...
  spec.summary       = %q{eki-powerpoint is a Ruby gem that can create a PowerPoint presentation based on a standard pptx template.}
